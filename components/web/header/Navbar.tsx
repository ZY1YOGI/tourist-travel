  ...
  return (
    <nav className="flex items-center justify-between py-3 px-[5%] relative sm:px-[6%] lg:px-[8%] md:py-5 border_gradient border-b-8">
      <Link href="/" className="relative" title='Marsa Alam Holiday'>
        <h1 className="font-museomoderno sm:text-lg md:text-2xl dark:text-white" data-aos="fade-right" title='MA-HOLIDAY'>MA-HOLIDAY</h1>
      ...
      <ul className="navigation" ref={switchMenu}>
        ...
        <li className="relative group" id="nav-link-categories">
          ...
          <ul role="menu" className="group-hover:block font-song-myung z-50 text-center absolute hidden whitespace-nowrap space-y-5 py-5 top-8 left-[50%] max-md:left-[-100%] border-4 border-x-white border-y-primary rounded-xl px-1 bg-body-light dark:bg-body-dark">
