          ...
          <div className="lg:flex lg:items-center lg:-mx-6">
            <div className="lg:w-1/2 lg:mx-6">
              ...
              <div className="mt-6 w-80 md:mt-8">
                <h3 className="text-gray-600 dark:text-gray-200 lg:text-xl">Follow us</h3>
                ...
                <div className="flex mt-4 -mx-1.5 ">
                  ...
                  <a className="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500" href="https://www.facebook.com/profile.php?id=100064009540678">
                    <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="mt-8 lg:w-1/2 lg:mx-6">
              <div
                ...
                <h1 className="text-lg font-medium dark:text-white">What do you want to ask</h1>
